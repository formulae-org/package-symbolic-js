...
Symbolic.setReducers = () => {
	...
	ReductionManager.addReducer("Symbolic.Assignment",        Symbolic.assignmentSymbolReducer, true);
	ReductionManager.addReducer("Symbolic.Assignment",        Symbolic.assignmentListReducer, true);
	ReductionManager.addReducer("Expression.Child",           Symbolic.childSymbolReducer, true);
	ReductionManager.addReducer("Symbolic.Assignment",        Symbolic.assignmentChildSymbolReducer, true);
	ReductionManager.addReducer("Symbolic.Function",          Symbolic.functionReducer);
	ReductionManager.addReducer("Symbolic.Assignment",        Symbolic.assignmentFunctionReducer, true);
	ReductionManager.addReducer("Symbolic.Local",             Symbolic.localArrayReducer, true);
	ReductionManager.addReducer("Symbolic.Local",             Symbolic.localReducer);
	ReductionManager.addReducer("Symbolic.Undefine",          Symbolic.undefineReducer, true);
	ReductionManager.addReducer("Expression.Cardinality",     Symbolic.cardinalitySymbolReducer, true);
	ReductionManager.addReducer("Expression.Cardinality",     Symbolic.cardinalityChildSymbolReducer, true);
	ReductionManager.addReducer("Symbolic.Return",            Symbolic.returnReducer);
	ReductionManager.addReducer("Expression.Append",          Symbolic.appendSymbolReducer,  true, ReductionManager.PRECEDENCE_HIGH);
	ReductionManager.addReducer("Expression.Prepend",         Symbolic.prependSymbolReducer, true, ReductionManager.PRECEDENCE_HIGH);
	ReductionManager.addReducer("Expression.Insert",          Symbolic.insertSymbolReducer,  true, ReductionManager.PRECEDENCE_HIGH);
	ReductionManager.addReducer("Expression.Delete",          Symbolic.deleteSymbolReducer,  true, ReductionManager.PRECEDENCE_HIGH);
	ReductionManager.addReducer("Symbolic.Lambda",            Symbolic.lambdaReducer, true);
	...
	ReductionManager.addReducer("Symbolic.Assignment",        Symbolic.assignmentPitfallReducer, ReductionManager.PRECEDENCE_LOW);
};
