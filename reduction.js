...
// Lambda application
// LambdaApplication(lambda, parameters, values)
...
Symbolic.lambdaApplication = async (app, session) => {
	...
	if (parameters.children.length > 0) {
		...
		for (let i = 0, n = values.children.length; i < n; ++i) {
			...
			Symbolic.replaceSymbol(body, symbol, symbol + "_");
		}
	...
	//session.log("Lambda application");
...
Symbolic.setReducers = () => {
	ReductionManager.addReducer("Symbolic.Symbol",            Symbolic.symbolReducer);
	ReductionManager.addReducer("Symbolic.Assignment",        Symbolic.assignmentSymbolReducer,       { special: true });
	ReductionManager.addReducer("Symbolic.Assignment",        Symbolic.assignmentListReducer,         { special: true });
	ReductionManager.addReducer("Expression.Child",           Symbolic.childSymbolReducer,            { special: true });
	ReductionManager.addReducer("Symbolic.Assignment",        Symbolic.assignmentChildSymbolReducer,  { special: true });
	ReductionManager.addReducer("Symbolic.Function",          Symbolic.functionReducer);
	ReductionManager.addReducer("Symbolic.Assignment",        Symbolic.assignmentFunctionReducer,     { special: true });
	ReductionManager.addReducer("Symbolic.Local",             Symbolic.localArrayReducer,             { special: true });
	ReductionManager.addReducer("Symbolic.Local",             Symbolic.localReducer);
	ReductionManager.addReducer("Symbolic.Undefine",          Symbolic.undefineReducer,               { special: true });
	ReductionManager.addReducer("Expression.Cardinality",     Symbolic.cardinalitySymbolReducer,      { special: true });
	ReductionManager.addReducer("Expression.Cardinality",     Symbolic.cardinalityChildSymbolReducer, { special: true });
	ReductionManager.addReducer("Symbolic.Return",            Symbolic.returnReducer);
	ReductionManager.addReducer("Expression.Append",          Symbolic.appendSymbolReducer,  { special: true, precedence: ReductionManager.PRECEDENCE_HIGH });
	ReductionManager.addReducer("Expression.Prepend",         Symbolic.prependSymbolReducer, { special: true, precedence: ReductionManager.PRECEDENCE_HIGH });
	ReductionManager.addReducer("Expression.Insert",          Symbolic.insertSymbolReducer,  { special: true, precedence: ReductionManager.PRECEDENCE_HIGH });
	ReductionManager.addReducer("Expression.Delete",          Symbolic.deleteSymbolReducer,  { special: true, precedence: ReductionManager.PRECEDENCE_HIGH });
	ReductionManager.addReducer("Symbolic.Lambda",            Symbolic.lambdaReducer,        { special: true });
	ReductionManager.addReducer("Symbolic.LambdaApplication", Symbolic.lambdaApplication);
	ReductionManager.addReducer("Symbolic.LambdaBuilder",     Symbolic.lambdaBuilderReducer);
	ReductionManager.addReducer("Symbolic.Assignment",        Symbolic.assignmentPitfallReducer, { precedence: ReductionManager.PRECEDENCE_LOW });
};
